...
//								"Authorization, Link");
						...
						corsService.setAllowedHeaders(new HashSet<String>(Arrays.asList("Content-Type,Accept")));
						corsService.setExposedHeaders(new HashSet<String>(Arrays.asList("Location,Access-Control-Allow-Origin")));
						corsService.setMaxAge(10);

// 绑定到应用
						getContext().getAttributes().put(CorsService.class.getName(), corsService);
